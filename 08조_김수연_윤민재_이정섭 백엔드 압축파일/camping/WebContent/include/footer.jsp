        ...
        <div class="container">
          ...
          <div class="row flex-center">
            <div class="col-auto mb-4">
              <p class="mb-0 fs--1 text-dark">Copyright &copy; 2023. Kim-Suyeon & Yun-Minjae & Lee-Jungsub
              </p>
            </div>
          </div>
          <div class="row flex-center">
            <div class="col-auto">
              <ul class="list-unstyled list-inline">
                <li class="list-inline-item me-3"><a class="text-decoration-none" href="https://www.youtube.com/">
                ...
                <li class="list-inline-item me-3"><a class="text-decoration-none" href="https://ko-kr.facebook.com/">
                ...
                <li class="list-inline-item me-3"><a href="https://twitter.com/?lang=ko">
                ...
                <li class="list-inline-item me-3"><a href="https://www.instagram.com/">
